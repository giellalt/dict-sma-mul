# Dictionary for sma — nob

This repository contains source files for a dictionary from South Sámi to Norwegian Bokmål. The content is licensed under the CC-BY-4.0 license.
