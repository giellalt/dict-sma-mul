...
SMANOBNAME  = Nordsamisk-norsk ordbok.dictionary
...
ADJ         = adj_smanob.xml
#ADV         = adverb_smanob.xml
NOUN        = noun_smanob.xml
#NOUNC       = nounCommon_smanob.xml
#NOUNP       = nounProper_smanob.xml
OTHER       = other_smanob.xml
VERB        = verb_smanob.xml
SN_XML      = smanob.xml
SN_XSL      = smanob.xsl
SN_LEXC     = smanob.lexc
SN_HTML     = smanob.html
